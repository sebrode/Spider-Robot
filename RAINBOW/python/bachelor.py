...
def show_simple_setup():
    ...
    fullAngleMatrix = np.array([greyAngleMatrix[[1, 3, 6, 9], :], blackAngleMatrix[[1, 3, 6, 9], :], redAngleMatrix[[1, 3, 6, 9], :], blueAngleMatrix[[1, 3, 6, 9], :]])
    fullObjectMatrix = np.array([greyObjectMatrix, blackObjectMatrix, redObjectMatrix, blueObjectMatrix])
